...
7. **MLS-24/G1:** the D575 rollout for development (TSK-d43263). The operator selected the G1
   ...
   - DEC-09fb2f/D575 is **`decided`** as of 2026-09-26, scoped to G1 for development, with G2 tracked as
     a production-readiness item. This is the operator's direct decision, preserved by Codex as
     `OPERATOR-DISPOSITION-Codex-gen-bdb784-D575-ADR-decided-2026-09-26.md` (`3b3a2666`). Decided is
     not implemented: the served build has not been shown to meet G1, and each implementation or live
     unit keeps its own review, clearance and grant.
