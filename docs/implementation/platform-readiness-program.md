...
| L8 Metric Registry | 🟢 | 🟢 | 🟢 | full **Metric Registry** UI — tabbed Family/Group/Member (counts + coverage + realizability) + member provenance detail + governed create doors (New Family/Group direct; Author metric via the M12 panel with maker/checker/judge provenance); live-verified, bc-admin PR #45 |
