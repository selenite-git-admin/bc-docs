...
L8 Metric Registry (seed -> directory member -> realized MCF authority) — SA  [renamed from "Metric Registration / Directory" per DEC-a67bae/D590 Amendment 1, 2026-09-19]
