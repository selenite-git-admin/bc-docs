...
The "HELD until Track C" condition above is determined SATISFIED by the D541 successor state (Track C was retired by DEC-793e13/D540 and superseded by DEC-c48b0f/D541; the activation gate the hold intended is now substrate-enforced). Per DEC-908548: SC + AC + D500 soft-references for Odoo are RELEASED; OC/CC + metric realization remain held pending certification-lane completion (PLN-457cd0 v12 §11.A). The "BC first, then Odoo" sequencing is AMENDED to Odoo-first, ratifying the Odoo 19 Enterprise pilot world-build program state. All other content of this ADR stands.
