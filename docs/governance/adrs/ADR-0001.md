---
uid: DEC-000001
title: "Platform Host Services — control plane and shared services foundation"
description: "Establishes Platform Host Services (PHS) as the control plane: contract enforcement, IAM, tenancy, secrets, observability. Never holds tenant business data."
status: superseded
date: 2025-09-17
project: platform
domain: platform
...
## Context
The DetaJetty Data Platform requires a central control plane and a foundation of shared services.  
