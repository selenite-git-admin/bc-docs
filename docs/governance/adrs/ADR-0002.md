---
uid: DEC-000002
title: "Contract lifecycle in Admin app, enforcement in Platform Host"
description: "Admin app manages contract lifecycle (seed, draft, approve, publish). Platform Host stores and enforces active contracts only."
status: superseded
date: 2025-09-17
project: platform
domain: contracts
...
## Context
DetaJetty uses three contracts — Raw, GDP, KPI — to govern data ingestion, transformation, and metrics delivery.  
